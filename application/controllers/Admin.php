...
class Admin extends CI_Controller
{
    ...
    public function tambah()
    {
        ...
        $this->form_validation->set_rules(
            'password',
            'Password',
            'required|is_unique[admin.password]|min_length[4]',
            array('required' => 'Password harus diisi', 'min_length' => 'Panjang password yang dimasukkan adalah minimal 4 karakter')
        );
