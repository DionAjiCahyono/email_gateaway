                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>daftar <span class="table-project-n">Peminjam</span> Buku</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div id="toolbar">
                                            <a href="<?= base_url('peminjamCRUD/index'); ?>" class="btn btn-info btn-icon-split mb-3 mt-1">
                                     ...
                                     <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="email" data-editable="true">Total Pengembalian</th>
                                        ...
                                        <?php $no=1; foreach ($peminjam as $pnjm) : ?>
                                            <tr>
                                                ...
                                                <td > <?php echo anchor(
                                                'Data_peminjam/halamanUpdate/' . $pnjm->id_peminjam,
                                                '<div  class="btn btn-primary"><i class="fa fa-info-circle adminpro-informatio"></i></div>' ) ?>
                                                </td>
                                                <td > <?php echo anchor(
                                                'Data_peminjam/fungsiDelete/' . $pnjm->id_peminjam,
                                                '<div  class="btn btn-warning"><i class="fa fa-exclamation-triangle adminpro-warning-danger"></i></div>' ) ?>
                                                </td>
